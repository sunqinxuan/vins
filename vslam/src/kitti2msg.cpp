...
#
# Last modified: 2023-08-10 14:22
#
# Filename: kitti_node.cpp
#
# Description:
#
************************************************/
...
int main(int argc, char **argv) {
  ...
  //	if(argc != 3)
  //	{
  //		printf("please intput: rosrun vins kitti_odom_test [config file]
  //[data folder] \n" 			   "for example: rosrun vins
  // kitti_odom_test
  //"
  ...
  std::string dataPath = "/home/sun/vins_sqx/bagfile/kitti/00/";
  std::string output_folder = "/home/sun/vins_sqx/output/";
  //
  ...
  FILE *outFile;
  outFile = std::fopen((output_folder + "vio.txt").c_str(), "w");
  if (outFile == NULL)
