...
#include "loopfusion/ThirdParty/DBoW/TemplatedDatabase.h"
#include "loopfusion/ThirdParty/DBoW/TemplatedVocabulary.h"
...
class PoseGraph {
public:
  PoseGraph(std::string config_file_path);
  ~PoseGraph();
...
private:
  ...
  std::string pose_graph_save_path_;
