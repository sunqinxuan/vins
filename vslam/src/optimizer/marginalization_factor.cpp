...
bool MarginalizationFactor::Evaluate(double const *const *parameters,
  ...
  for (int i = 0;
    ...
    if (size != 7)
      ...
      // Utility::positify(Eigen::Quaterniond(x0(6), x0(3), x0(4),
      // x0(5)).inverse() * Eigen::Quaterniond(x(6), x(3), x(4), x(5))).vec();
      Eigen::Quaterniond q =
          Eigen::Quaterniond(x0(6), x0(3), x0(4), x0(5)).inverse() *
          Eigen::Quaterniond(x(6), x(3), x(4), x(5));
      dx.segment<3>(idx + 3) = 2.0 * q.vec();
      if (!((Eigen::Quaterniond(x0(6), x0(3), x0(4), x0(5)).inverse() *
        ...
        // -Utility::positify(Eigen::Quaterniond(x0(6), x0(3), x0(4),
        // x0(5)).inverse() * Eigen::Quaterniond(x(6), x(3), x(4), x(5))).vec();
        q = Eigen::Quaterniond(x0(6), x0(3), x0(4), x0(5)).inverse() *
            Eigen::Quaterniond(x(6), x(3), x(4), x(5));
        dx.segment<3>(idx + 3) = 2.0 * (-q.vec());
      }
    }
