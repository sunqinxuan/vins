...
DataFlow::DataFlow(ros::NodeHandle &nh, std::string work_space_path) {
  ...
  pub_track_image_ =
      nh.advertise<sensor_msgs::Image>("track_image", 1000);
  pub_odometry_ = nh.advertise<nav_msgs::Odometry>("vins_odometry", 1000);
  pub_path_ = nh.advertise<nav_msgs::Path>("vins_path", 1000);
}
